...
//MAIN FUNCTION WITH ACTUAL CLICK COUNTER
...
const dogClick = () => {
    ...
    // DOG FACE & SNACK ANIMATION FUNCTION
    const openMouth = () => {
        if (window.innerHeight > window.innerWidth) {
...
// BONUS ANIMATION FUNCTION WITH TIME INTERVAL
const bonusGame = () => {
...
//UPGRADE POINTS ANIMATION FUNCTION
const upgradePoints = () => {
...
//CHANGE IMAGE AND ANIMATE AT END OF THE CURRENT ROUND
const endRound = () => {
